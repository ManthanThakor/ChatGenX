                    ...
                    <div className="slide flex mb-16 items-start">
                      ...
                      <div className="max-w-lg">
                        ...
                        <p className="text-xl text-gray-400">
                          ChatGenX AI revolutionizes the way you create content.
                    ...
                    <div className="slide flex mb-16 items-start">
                      ...
                      <div className="max-w-lg">
                        ...
                        <p className="text-xl text-gray-400">
                          ...
                          stories, ChatGenX AI tailors content to your specific
                    ...
                    <div className="slide flex items-start">
                      ...
                      <div className="max-w-lg">
                        ...
                        <p className="text-xl text-gray-400">
                          ...
                          ChatGenX AI becomes a natural extension of your
